(function (global, factory) {
    ...
    /* src/Ckeditor.svelte generated by Svelte v3.59.2 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			attr(div, "id", /*randomGeneratedID*/ ctx[0]);
    		},
    		m(target, anchor) {
    ...
    function instance_1($$self, $$props, $$invalidate) {
    	...
    	function setUpEditorEvents() {
    		const emitInputEvent = evt => {
    			...
    			const data = $$invalidate(1, value = lastEditorData = instance.getData());
    	...
    	return [randomGeneratedID, value, editor, config, disabled];
    }
